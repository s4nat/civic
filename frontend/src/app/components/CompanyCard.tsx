...
export default function CompanyCard(props: CompanyCardProps) {
  return (
    <Link href={props.link}>
      <div className="bg-[#DDC9B4]/20 hover:bg-[#DDC9B4]/45 flex flex-col rounded-md p-5 ">
        <div className="flex justify-around items-center my-2">
          ...
          <div>
            ...
            <div className="flex items-center border-2 border-[#466362] rounded-full">
              <div className="text-[#466362] text-[16px] font-playfair mx-2">
                {props.fundCategory}
              </div>
            </div>
          </div>
